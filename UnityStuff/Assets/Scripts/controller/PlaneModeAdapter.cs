...
namespace controller
{
    public class PlaneModeAdapter : ShaderAdapter
    {
        ...
        private void InitializeOtherFields()
        {
            ...
            logger.Log(Logger.EventType.Step, "InitializeOtherFields(): Set indicatorCount in shader.");
        ...
        protected override void Compute()
        {
            ...
            logger.Log(Logger.EventType.Performance, $"Absorption factor calculation took {loop_time}.");
